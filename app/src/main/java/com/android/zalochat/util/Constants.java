...
public class Constants {//Chứa các biến Constains của hệ thống
    public static final String SHAREPREF_USER = "SharePreference_USER";//Định nghĩa tên của SharedPreference
    public static final String PHONE = "PHONE";//Định nghĩa biến số điện thoại
    public static final String USERID = "USERID";//Định nghĩa biến USERID
    public static final String USER_JSON = "USER_JSON";//Định nghĩa biến USER_JSON
    public static final String TEXT = "TEXT";//Định nghĩa biến TEXT, dùng khi tạo tin nhắn văn bản
    ...
    public static final String SUBMESSAGE_COLLECTION = "SUBMESSAGES";//Định nghĩa biến SUBMESSAGE_COLLECTION, dùng để định nghĩa tên của Collection submessage trên database
}
